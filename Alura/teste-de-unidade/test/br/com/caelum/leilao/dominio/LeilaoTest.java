...
public class LeilaoTest {
	...
	public void deveDobraroLanceAnterior() {
		...
		assertEquals(5000, leilao.getLances().get(leilao.getLances().size() -1).getValor(), 0.00001);
	}
	
	@Test
	public void naoDeveDobraroLanceAnteriorQuandoForSeguido() {
		Leilao leilao = new Leilao("Macbook Pro 15");
		Usuario steveJobs = new Usuario("Steve Jobs");
		Usuario billGates = new Usuario("Bill Gates");
	...
	@Test
	public void naoDeveCriarNovoLanceQuandoNaoExistirAnterior() {
		Leilao leilao = new Leilao("Macbook Pro 15");
		Usuario steveJobs = new Usuario("Steve Jobs");
		Usuario billGates = new Usuario("Bill Gates");
		...
		assertEquals(1, leilao.getLances().size());
		assertEquals(3500, leilao.getLances().get(leilao.getLances().size() -1).getValor(), 0.00001);
	}
	
	@Test
	public void naoDeveCriarNovoLanceDobradoQuandoExistirCincoLances() {
		Leilao leilao = new Leilao("Macbook Pro 15");
		Usuario steveJobs = new Usuario("Steve Jobs");
		Usuario billGates = new Usuario("Bill Gates");
